...
public class Annotator : Gtk.Application {
  ...
  private void start_application() {
    ...
    default_theme.add_resource_path( "/io/github/phase1geo/annotator/images/images/icons/hicolor" );
    ...
    if( std_input ) {
      ...
      if( !AnnotatorClipboard.paste( appwin.editor, true ) ) {
        appwin.notification( _( "Image paste error" ), _( "Image does not exist on the clipboard" ) );
        Process.exit( 1 );
      }
